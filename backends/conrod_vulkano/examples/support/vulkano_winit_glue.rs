// Taken from https://github.com/vulkano-rs/vulkano/blob/master/vulkano-win/src/lib.rs in order to use up2date winit together with vulkano
...
use winit::{self, EventsLoop, WindowBuilder, CreationError as WindowCreationError};
