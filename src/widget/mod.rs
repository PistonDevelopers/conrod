...
impl MaybeParent {
    ...
    /// use `get` instead.
    pub fn get_unchecked(&self, ui: &Ui, x_pos: Position, y_pos: Position) -> Index {
        match *self {
    ...
    pub fn get(&self, idx: Index, ui: &Ui, x_pos: Position, y_pos: Position) -> Option<Index> {
...
impl IndexSlot {
    ...
    pub fn get(&self, ui: &mut UiCell) -> NodeIndex {
